class Level1 extends Phaser.Scene
{
	...
	create_objects()
	{
		...
		deadly2_image.frame = 0;
		this.group_deadly2 = this.map.createFromObjects('items','death',deadly2_image);
		this.setup_objects(this.group_deadly2);
		
		
		var collectables = new Object()
		collectables.key = 'itemMap';
		collectables.frame = 1;
		this.group_coins = this.map.createFromObjects('items','gb',collectables);
